...
This work proposed desired closed loop dynamics based on a general mechanical model of a rigid body system.
...
Though not necessarily being a Lyapunov function, each approach comes with a formulation for a total energy that is positive definite, i.e.\ positive and zero if, and only if, the tracking objective is fulfilled.
