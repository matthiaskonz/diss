...
\end{align}
\end{subequations}
The closed loop kinetic equation is $\genForceInertiaC + \genForceDissC + \genForceStiffC = \tuple{0}$ and the actual controller can be solved by combing this with the model kinetics.
