...
Only the energy based approach requires additionally a transport map $\sysTransportMap$.
...
For a given left complement $\sysInputMatLComp$ we may also compute the matching force $\tuple{\lambda}$ which gives insight in how to adjust the control parameters $\{\bodyInertiaMatC{\BidxI}{\BidxII}, \bodyDissMatC{\BidxI}{\BidxII}, \bodyStiffMatC{\BidxI}{\BidxII}\}$ to minimize or even eliminate this deflection.
