...
% Depending on the actual constellation of $\lambda_1 \geq \lambda_2 \geq \lambda_3 \geq 0$ we have more critical points or submanifolds which are analyzed in the following:
\begin{subequations}
\begin{itemize}
