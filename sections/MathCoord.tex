...
The deduction above simplifies significantly if $\geoConstraintMat$ is full rank: then the combination of the columns of $\kinMat$ and $\InvGeoConstraintMat$ form a basis for $\RealNum^\numCoord$ and we can immediately deduce the following idientities:
\begin{subequations}
\begin{align}
