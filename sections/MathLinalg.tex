...
The following sets of real matrices are frequently used in this work: 
\begin{subequations}
\begin{align}
 &\text{(symmetric)}&
...
\subsection{Inner product, norm and metric}\label{sec:MathLinalgInnerNormMetric}
...
In \autoref{sec:RBSummary} we will derive the analogous operators for $\SpecialEuclideanGroup(3)$.
